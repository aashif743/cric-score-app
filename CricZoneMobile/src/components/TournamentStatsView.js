...
/**
 * Statistics body for a tournament. Pure render from an already fetched stats
 * object so it can be dropped into a tab without its own network call.
 */
const TournamentStatsView = ({ stats }) => {
